      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start space-y-6">
            ...
            {/* Store Type Badge */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-lime-100/90 border border-lime-300 text-lime-900 text-xs sm:text-sm font-bold shadow-xs">
              <span className="w-2 h-2 rounded-full bg-lime-600 animate-pulse"></span>
              <span>WHOLESALE &amp; RETAIL SHOWROOM</span>
            ...
            <div className="space-y-3">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white border border-lime-300 text-xs font-black shadow-xs">
                <Sparkles className="w-3.5 h-3.5 text-lime-600 animate-spin" style={{ animationDuration: '4s' }} />
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-slate-950 tracking-tight leading-[1.08]">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-slate-950 via-lime-700 to-emerald-700 block">
                  VIJAYA LAKSHMI ELECTRICALS
                </span>
                <span className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-slate-800 mt-1 block">
                  Everything You Need.{' '}
              ...
              <div className="text-base sm:text-lg font-bold text-slate-700 tracking-wide flex flex-wrap items-center gap-x-2.5 gap-y-1.5 pt-1">
                <span className="px-2.5 py-0.5 rounded-md bg-lime-50 text-lime-900 border border-lime-200 shadow-2xs font-bold">⚡ Electricals</span>
                <span className="text-slate-300">•</span>
                <span className="px-2.5 py-0.5 rounded-md bg-teal-50 text-teal-900 border border-teal-200 shadow-2xs font-bold">💧 Plumbing</span>
                <span className="text-slate-300">•</span>
                <span className="px-2.5 py-0.5 rounded-md bg-emerald-50 text-emerald-900 border border-emerald-200 shadow-2xs font-bold">🛁 Sanitary</span>
                <span className="text-slate-300">•</span>
                <span className="px-2.5 py-0.5 rounded-md bg-slate-100 text-slate-900 border border-slate-200 shadow-2xs font-bold">🔧 Hardware</span>
              </div>
            </div>
